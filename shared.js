(() => {
  ...
  const CONTACT = {
    phoneDisplay: "MyFarmBox India",
    phoneHref: "",
    email: "",
    whatsapp: "",
    instagram: "https://www.instagram.com/myfarmbox/",
    ...
    if (!dialog) {
      ...
      dialog.innerHTML = `
        <div class="call-dialog-card">
          ...
          <p class="eyebrow">Talk to MyFarmBox India</p>
  ...
  function renderHeader() {
    ...
    mount.innerHTML = `
      <header class="site-header">
        <a class="site-logo" href="/" aria-label="MyFarmBox India home">
          <img src="/assets/myfarmbox-logo.webp" alt="MyFarmBox India">
        </a>
    ...
    mount.innerHTML = `
      <footer class="site-footer">
        ...
        <div class="footer-bottom">
          © <span id="shared-year"></span> MyFarmBox India.
        </div>
      </footer>
  ...
  function readCartCount() {
    try {
      ...
      const cart = JSON.parse(localStorage.getItem("mfb_in_cart_v3") || "[]");
  ...
  window.addEventListener("storage", event => {
    if (event.key === "mfb_in_cart_v3") updateSharedCartCount();
  });
})();
